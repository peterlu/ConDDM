...
namespace npp
{
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp8u * pResult = nppiMalloc_8u_C1(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp8u * pResult =  nppiMalloc_8u_C2(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp8u * pResult =  nppiMalloc_8u_C3(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp8u * pResult = nppiMalloc_8u_C4(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp16u * pResult = nppiMalloc_16u_C1(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp16u * pResult = nppiMalloc_16u_C3(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp16u * pResult = nppiMalloc_16u_C4(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp16s * pResult = nppiMalloc_16s_C1(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp16s * pResult = nppiMalloc_16s_C4(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32s * pResult = nppiMalloc_32s_C1(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32s * pResult = nppiMalloc_32s_C3(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32s * pResult = nppiMalloc_32s_C4(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32f * pResult = nppiMalloc_32f_C1(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32f * pResult = nppiMalloc_32f_C2(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32f * pResult = nppiMalloc_32f_C3(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
    ...
    public:
        ...
        Malloc2D(unsigned int nWidth, unsigned int nHeight, unsigned int * pPitch)    
        {
            ...
            Npp32f * pResult = nppiMalloc_32f_C4(nWidth, nHeight, reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
